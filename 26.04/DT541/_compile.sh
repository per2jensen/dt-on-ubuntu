...
sudo apt install -y lld-17 llvm-17-dev llvm-17-runtime llvm-17 lldb-17 python3-lldb-17  \
   clang-17  clang-format-17 clang-tidy-17 clang-tools-17 python3-clang-17  \
   libc++-17-dev libc++1-17 \
   libc++abi-17-dev libc++abi1-17  \
   libclang-17-dev libclang1-17 liblldb-17-dev libllvm-17-ocaml-dev libomp-17-dev libomp5-17  \
   libopencl-clang-21-dev libopencl-clang21.1 opencl-c-headers opencl-headers libclang-common-17-dev nvidia-opencl-dev ocl-icd-opencl-dev \
   intltool cmake
if [ $? != "0" ]
then
...
sudo apt install -y  libxml2-utils xsltproc libsaxon-java libpthreadpool0 libpthreadpool-dev  \
   ...
   libgraphicsmagick1-dev imagemagick libmagick++-7.q16-dev  libopenexr-dev libopenexr-3-1-30 desktop-file-utils libgmic-dev
if [ $? != "0" ]
then
